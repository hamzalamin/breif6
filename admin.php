...
<section class="container mt-5 border border-primary rounded w-75 p-3" style="background-color: rgba(26, 124, 209, 0.481);">
            ...
            <div class="col-md-6">
                <form method="post" action="">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="categoryPicture" name="picture" required>
                    </div>
...
<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == "POST" && isset($_POST['category'])) {
        ...
        $sql = "INSERT INTO categories (categorie_name, categorie_description, categorie_pic) VALUE ('$catyname', '$catypic', '$catydescription')";
    ...
    <?php
        ...
        if ($_SERVER['REQUEST_METHOD'] == "POST" && isset($_POST['product'])) {
          $picprod = $_POST['pictureprod'];
          $nameprod = $_POST['etiquette'];
          $barr = $_POST['codebar'];
          $prix_dachat = $_POST['pricedachat'];
          $prix_final = $_POST['prixfin'];
          $prix_offre = $_POST['offre'];
          $discprod = $_POST['productdiscription'];
          $qtemin = $_POST['quantite_min'];
          $qte_stock = $_POST['quantite_stock'];
          $selectoption = $_POST['selectOptions'];

          $mysql = "INSERT INTO products (image, etiquette, code_barres, prix_dachat, prix_final, Offre_de_prix, description, quantite_min, quantite_stock, selectOptions) VALUE ('$picprod','$nameprod', '$barr', '$prix_dachat', '$prix_final', '$prix_offre', '$discprod', '$qtemin', '$qte_stock' ,'$selectoption')";
